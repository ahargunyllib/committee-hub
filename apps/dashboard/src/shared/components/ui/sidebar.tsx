...
// biome-ignore lint/performance/noNamespaceImport: shadcn sidebar uses React namespace types and hooks throughout this generated primitive.
...
function SidebarProvider({
  ...
  const setOpen = React.useCallback(
    (value: boolean | ((value: boolean) => boolean)) => {
      ...
      // biome-ignore lint/suspicious/noDocumentCookie: persists local sidebar UI state only.
